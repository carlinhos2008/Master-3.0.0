...
"""Verify that starting mastercore with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mastercore with -? for help text")
        ...
        self.log.info("Start mastercore with -version for version information")
