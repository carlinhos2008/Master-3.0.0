...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected MASTER supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check MASTER supply at the beginning
        # ------------------------------------------
        # MASTER supply: block rewards minus burned fees for minting
        ...
        # Verify that MASTER supplies were properly updated after the spends and reorgs
        self.log.info("Check MASTER supply...")
