...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='mastercore.conf'
CONFIGFOLDER='/root/.mastercore'
COIN_DAEMON='mastercored'
COIN_CLI='mastercore-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/MasterStakeCore/MASTER/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='mastercore'
COIN_PORT=23990
RPC_PORT=23980
