...
#define MyAppName "MasterCore Core"
#define MyAppPublisher "2022 MASTERCORE Developers"
#define MyAppURL "https://masterstake.top"
#define MyAppExeName "mastercore-qt.exe"
#define MyAppExtraData "https://explorer.masterstake.top/bootstraps/MASTER/bootstrap.zip"
...
AppId={{EF6FB68C-D971-484B-9865-337F2AA2BED8}
AppName={#MyAppName}
...
DefaultDirName={autopf}\MasterCore
...
OutputDir=.\output
OutputBaseFilename=MasterCoreSetup
...
DefaultGroupName=MasterCore Core
...
[Files]
Source: ".\package\mastercore-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\MasterCore\MasterCore-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\MasterCore\MasterCore-Qt,strDataDir|{userappdata}\MasterCore\}');
  Result := True;
end;
