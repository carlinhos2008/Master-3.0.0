...
/** Utility functions used by the MasterCore Qt UI.
 */
namespace GUIUtil
{
...
// Render MASTER addresses in monospace font
...
// Parse "mastercore:" URI into recipient object, return true on successful parsing
