...
/* MasterCore GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MasterCore"
#define QAPP_ORG_DOMAIN "mastercore.org"
#define QAPP_APP_NAME_DEFAULT "MasterCore-Qt"
#define QAPP_APP_NAME_TESTNET "MasterCore-Qt-testnet"
