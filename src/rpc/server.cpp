...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MASTER features */
        {"mastercore", "listmasternodes", &listmasternodes, true },
        {"mastercore", "getmasternodecount", &getmasternodecount, true },
        {"mastercore", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"mastercore", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"mastercore", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"mastercore", "masternodecurrent", &masternodecurrent, true },
        {"mastercore", "startmasternode", &startmasternode, true },
        {"mastercore", "reloadmasternodeconfig", &reloadmasternodeconfig, true },
        {"mastercore", "createmasternodekey", &createmasternodekey, true },
        {"mastercore", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"mastercore", "listmasternodeconf", &listmasternodeconf, true },
        {"mastercore", "getactivemasternodecount", &getactivemasternodecount, true },
        {"mastercore", "getmasternodestatus", &getmasternodestatus, true },
        {"mastercore", "getmasternodewinners", &getmasternodewinners, true },
        {"mastercore", "getmasternodescores", &getmasternodescores, true },
        {"mastercore", "mnsync", &mnsync, true },
        {"mastercore", "spork", &spork, true },
        {"mastercore", "mnping", &mnping, true },
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:23980/\n";
}
