...
const char * const PIVX_CONF_FILENAME = "mastercore.conf";
const char * const PIVX_PID_FILENAME = "mastercore.pid";
const char * const PIVX_MASTERNODE_CONF_FILENAME = "masternode.conf";
const char * const PIVX_ACTIVE_MASTERNODE_CONF_FILENAME = "activemasternode.conf";


// MasterCore only features
// Masternode
...
#else
    const char* pszModule = "mastercore";
#endif
    if (pex)
        return strprintf(
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty mastercore.conf if it does not exist
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override mastercore.conf
