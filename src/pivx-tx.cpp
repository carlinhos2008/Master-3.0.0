...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MasterCore mastercore-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mastercore-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mastercore transaction") + "\n" +
                               "  mastercore-tx [options] -create [commands]   " + _("Create hex-encoded mastercore transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mastercore transaction
