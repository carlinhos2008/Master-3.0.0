Contributing to MasterCore Core
============================

The MasterCore Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MasterCore Core project, and is not to be
confused with overall MasterCore Network Protocol consensus changes.

Whether a pull request is merged into MasterCore Core rests with the project merge
...
Patches that change MasterCore consensus rules are considerably more involved than
...
Where a patchset proposes to change the MasterCore consensus, it must have been
...
The project leader is the release manager for each MasterCore Core release.
